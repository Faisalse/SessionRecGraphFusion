...
class FLCSP:
    def __init__(self, epoch =  1, lr= 0.001, batch_size= 100, embedding_size= 50, hidden_size= 100, dropout= 0.1, l2 = 0.00001):
    ...
    def predict_next(self, sid, prev_iid, items_to_predict, timestamp=0):
        ...
        sub_scores_k100_index = test_score.topk(100)[1]
        sub_scores_k100_score = test_score.topk(100)[0]
